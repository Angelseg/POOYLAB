...
public class App {
    public static void main(String[] args) {
        ...
        Float[0] = new Compacto("ZG100293049","Ford", 2010, 150000,5,2);
        Float[1] = new Compacto("ZG100389485","Nissan", 2023, 350000,5,4);
        Float[2] = new Camioneta("ZZ1002001983","Chevrolet", 2024, 1000000,8,5);
        Float[3] = new Camioneta("ZZ1002001983","Merceds", 2024, 500000,6,5);

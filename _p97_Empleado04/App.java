...
public class App {
    public static void main(String[] args) {
        ...
        empleados.add(new Empleado("Juan Perico",29,'H',true));
        empleados.add(new Empleado("Maria de Jesus",32,'M',false));
        ...
        System.out.println("Promedios edades : " + (suma/empleados.size()));

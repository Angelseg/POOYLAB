...
public class _08_FuncionesTrigonometricas {
    public static void main(String[] args) {
        System.out.print("\033[H\033[2J");
        System.out.flush();
        System.out.printf("Dame un ángulo en grados: ");
        ...
        System.out.println(String.format("El ángulo es: %.2f, Coseno: %.2f, Tangente: %.2f", angulor, sen, cos, tan));
    }
}

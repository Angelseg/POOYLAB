...
public class App extends JFrame implements ActionListener {
    ...
    JDialog jdlAcercaDe;
    JLabel lblDatos,lblNombre,lblEdad,lblSexo,lblEstC,lblDesc,lblSalario;
    JTextField txtNombre,txtEdad,txtSexo,txtEstC,txtDesc,txtSalario;
    JScrollPane spane;
    JTable table;
    ...
    lblDatos = new JLabel("<html>Programación Oriendada a Objetos I<br>Angel Adan Segovia Chairez</html>",JLabel.CENTER);
    ...
    lblEstC = new JLabel("Estado Civil");
    lblEstC.setHorizontalAlignment(SwingConstants.RIGHT);
    txtEstC = new JTextField();
    pnlDatos.add(lblEstC);
    pnlDatos.add(txtEstC);
    ...
    public void mostrarDatos(int ren) {
        ...
        txtEstC.setText(datos.get(ren).getEstCiv());
        txtDesc.setText(datos.get(ren).getDescripcion());
    ...
    public void guardarCampos() {
        ...
        jug.setEstCiv( txtEstC.getText() );
        jug.setDescripcion(txtDesc.getText());

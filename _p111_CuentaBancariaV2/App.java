...
public class App {
    public static void main(String[] args) {
        ...
        mibanco.getClientes().get(0).agregarCuenta(new CuentasdeCheques(1000,500));
        mibanco.getClientes().get(1).agregarCuenta(new CuentasdeCheques(2500,500));
        mibanco.getClientes().get(2).agregarCuenta(new CuentasdeCheques(2000,600));
